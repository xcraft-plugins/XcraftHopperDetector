...
public class StartCommand extends AbstractCommand
{
    ...
    protected class ProgressReporter implements HopperDetector.IProgressReporter
    {
        ...
        public ProgressReporter(final IOutput toSender, final FinishCallback finishCallback) {
    ...
    class FinishCallback
    {
        ...
        public FinishCallback(final AbstractCommand listCommand, final CommandSender sender) {
            this.listCommand = listCommand;
            this.sender = sender;
        }
